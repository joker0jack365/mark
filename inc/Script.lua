...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/RISK_00"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : RISK_00](https://t.me/RISK_00)' ,nil,inline,msg.id_)
return false
end
...
local inline = {{{text="★  أّلَمًبًرمًجّ أّلَأّسِـأّسِـى ★",url="https://t.me/V_P_E"}}}
send_key(msg.sender_user_id_,'   [★  أّلَمًبًرمًجّ أّلَأّسِـأّسِـى ★](https://t.me/V_P_E)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المطور باد" and msg.type == "pv" then
local inline = {{{text="المطور باد",url="https://t.me/pabl0oooo"}}}
send_key(msg.sender_user_id_,'   [المطور باد](https://t.me/pabl0oooo)' ,nil,inline,msg.id_)
return false
end
...
• الروايات  <> سيقوم البوت بعرض قائمه من الروايات

• سيتم اضافه باقي المميزات قريبا •
_____

[𝐃𝐄𝐕 : 𝐉𝐎𝐊𝐄𝐑](https://t.me/eljo_ker_m)
...
[𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](https://t.me/A_j_o_k_e_r)

[𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](https://t.me/QpSSpQ)

[𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](https://t.me/pabl0oooo)

[𝑪𝑶𝑴𝑴𝑼𝑵𝑰𝑪𝑨𝑻𝑰𝑶𝑵](https://t.me/RISK_00)

[𝑻𝑶 𝑻𝑨𝑳𝑲 𝑻𝑶 𝑼𝑺](https://t.me/f_ire_awn45bot)
]]
end
...
elseif Text== "جوكر" or Text== "الجوكر" then return  sendMsg(msg.chat_id_,msg.id_,"[عم التيلي يبني](https://t.me/A_j_o_k_e_r)")
elseif Text== "دارك" or Text== "DARK" then return  sendMsg(msg.chat_id_,msg.id_,"[اضغط هنا لمراسله دارك](https://t.me/TTnnT)")
...
elseif Text== "بابلو" then return  sendMsg(msg.chat_id_,msg.id_,"[♡مطور سورس مارك](https://t.me/pabl0oooo)")
...
elseif Text== "الرمز المفقود"  then  return sendMsg(msg.chat_id_,msg.id_,"[الرمز المفقود  𖡼](https://t.me/SOURCE_MARK/14)."  )
elseif Text== "جثه في الخندق"  then return sendMsg(msg.chat_id_,msg.id_," [جثة في الخندق  𖡼](https://t.me/SOURCE_MARK/21) ")
elseif Text== "اللوح الازرق"  then return sendMsg(msg.chat_id_,msg.id_,"[اللوح الازرق  𖡼](https://t.me/SOURCE_MARK/19)")
elseif Text== "نيلوفر الاسود"  then return sendMsg(msg.chat_id_,msg.id_,"[نيلوفر الاسود  𖡼](https://t.me/SOURCE_MARK/16)")
elseif Text== "في القطار السعيد"  then return sendMsg(msg.chat_id_,msg.id_,"[في القطار السريع  𖡼](https://t.me/SOURCE_MARK/17).")
elseif Text== "كبرياء وتحمل"  then return sendMsg(msg.chat_id_,msg.id_,"[كبرياء وتحمل  𖡼](https://t.me/SOURCE_MARK/13).")
elseif Text== "الامير السعيد"  then  return sendMsg(msg.chat_id_,msg.id_,"[الامير السعيد  𖡼](https://t.me/SOURCE_MARK/15)."  )
elseif Text== "الانسان الاخير"  then return sendMsg(msg.chat_id_,msg.id_,"[الانسان الاخير  𖡼](https://t.me/SOURCE_MARK/18) .")
elseif Text== "واختفي كل شئ"  then return sendMsg(msg.chat_id_,msg.id_,"[واختفي كل شئ  𖡼](https://t.me/SOURCE_MARK/20)")
elseif Text== "ما تخبئه لنا النجوم"  then return sendMsg(msg.chat_id_,msg.id_,"[ما تخبئه لنا النجوم  𖡼](https://t.me/SOURCE_MARK/9).")
elseif Text== "بعد النسيان."  then return sendMsg(msg.chat_id_,msg.id_," [بعد النسيان  𖡼](https://t.me/SOURCE_MARK/10)  ")
elseif Text== "الشفق"  then return sendMsg(msg.chat_id_,msg.id_,"[روايه الشفق الجزء الاول  𖡼](https://t.me/SOURCE_MARK/12)")
elseif Text== "يوميات كئيب"  then return sendMsg(msg.chat_id_,msg.id_,"[يوميات كئيب  𖡼](https://t.me/SOURCE_MARK/11)")
elseif Text== "مقبره الحيوانات."  then return sendMsg(msg.chat_id_,msg.id_," [مقبره الحيوانات 𖡼](https://t.me/SOURCE_MARK/7)"
elseif Text== "التحرر"  then return sendMsg(msg.chat_id_,msg.id_,"[التحرر  𖡼](https://t.me/SOURCE_MARK/8)")
elseif Text== "روايه المخلوق"  then return sendMsg(msg.chat_id_,msg.id_,"[روايه المخلوق  𖡼](https://t.me/SOURCE_MARK/4)")
elseif Text== "في حضره الجن"  then return sendMsg(msg.chat_id_,msg.id_,"[في حضره الجن  𖡼](https://t.me/SOURCE_MARK/5).")
elseif Text== "لقاء مع كاتب الرعب"  then return sendMsg(msg.chat_id_,msg.id_,"[لقاء مع كاتب الرعب  𖡼](https://t.me/SOURCE_MARK/6) .")
elseif Text== "موسوعه الظلام"  then  return sendMsg(msg.chat_id_,msg.id_,"[موسوعه الظلام  𖡼](https://t.me/SOURCE_MARK/3)."  )
