...
local inline = {{{text="المطور بادا",url="https://t.me/pabl0oooo"}}}
...
elseif Text== "باد" or Text== "بابلو" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس مارك](https://t.me/pabl0oooo)")
